...
class ArgsNameTest {
    ...
    void whenValueIsMissed() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"-Xms="}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
                .hasMessageContaining("Error: This argument '-Xms=' does not contain a value");
    }
    ...
    void whenNoEqualSign() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"-Xms:512"}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
                .hasMessageContaining("Error: This argument '-Xms:512' does not contain an equal sign");
    }

    @Test
    void whenNoHyphenStartsWith() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"Xms=512"}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
                .hasMessageContaining("Error: This argument 'Xms=512' does not start with a '-' character");
    }
