...
class NonCollisionMapTest {
    ...
    @Test
    void whenPutSameKeyWithDifferentValues() {
        assertThat(map.put(4, "wow")).isFalse();
        assertThat(map.put(4, "123")).isFalse();
        assertThat(map.put(4, "want to be here")).isFalse();
        assertThat(map.get(4)).isEqualTo("4");
    }

    @Test
    void whenPutNewValue() {
        assertThat(map.put(5, "199")).isTrue();
    }

    @Test
    void whenPutNewKeyWithSameHash() {
        assertThat(map.put(17, "555")).isFalse();
        assertThat(map.put(18, "555")).isFalse();
        assertThat(map.put(19, "555")).isFalse();
        assertThat(map.put(20, "555")).isFalse();
        assertThat(map.put(21, "555")).isTrue();
    }
    ...
    @Test
    void whenPutAndRemoveSameElement() {
    ...
    @Test
    void whenRemoveElAddElAndRemoveAll() {
        assertThat(map.remove(1)).isTrue();
